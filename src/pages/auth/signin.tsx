        ...
        {Object.values(providers).map((provider) => (
          <div key={provider.name}>
            <button
              ...
              className="flex bg-white items-center justify-around w-70 p-3 text-black border-gray-300 shadow-md m-2 hover:bg-gray-100 font-medium"
            >
              <div className="mx-3 w-8 flex justify-center">
...
function Icon(props: { name: string }) {
  if (props.name === "GitHub") {
    ...
    return (
      <svg width="38" height="32" viewBox="0 0 71 55" fill="none">
